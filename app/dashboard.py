...
def load_all_lookups():
    ...
    lookups["motion_dec"] = {"G": "Granted", "D": "Denied", "M": "Moot", "O": "Other", "W": "Withdrawn", "J": "Jurisdiction Returned", "P": "Pending", "C": "Consolidated"}
    lookups["bond_dec"] = {"C": "Conditional Release", "A": "Administrative", "N": "No Bond", "S": "Set Bond", "J": "Jurisdiction", "G": "Granted", "W": "Withdrawn", "D": "Denied", "R": "Revoked", "E": "Expired"}
    lookups["filing_method"] = {"6": "EOIR Form 6", "7": "EOIR Form 7", "E": "Electronic", "P": "Paper", "M": "Mail", "H": "Hand Delivered"}
...
FIELD_META = {
    ...
    "tbl_court_motions": {
        "REC_TYPE": {"label": "Motion Type", "type": "lookup", "lookup": "motion_type",
                     "lookup_table": "tbllookupmotiontype", "code_col": "strMotionCode", "desc_col": "strMotionDesc"},
        "DEC": {"label": "Motion Decision", "type": "lookup", "lookup": "motion_dec"},
        "COMP_DATE": {"label": "Motion Decision Date", "type": "date"},
        "MOTION_RECD_DATE": {"label": "Motion Filed Date", "type": "date"},
        "DATMOTIONDUE": {"label": "Motion Due Date", "type": "date"},
        ...
        "STRFILINGMETHOD": {"label": "Filing Method", "type": "lookup", "lookup": "filing_method"},
        "BASE_CITY_CODE": {"label": "Court", "type": "lookup", "lookup": "base_city",
                           "lookup_table": "tbllookupbasecity", "code_col": "BASE_CITY_CODE", "desc_col": "BASE_CITY_NAME"},
        "HEARING_LOC_CODE": {"label": "Hearing Location", "type": "lookup", "lookup": "hearing_loc",
                             "lookup_table": "tbllookuphloc", "code_col": "HEARING_LOC_CODE", "desc_col": "HEARING_LOC_NAME"},
        ...
        "STAY_GRANT": {"label": "Stay Granted", "type": "text"},
        "APPEAL_RSVD": {"label": "Appeal Reserved", "type": "text"},
        "OSC_DATE": {"label": "Filing Date (OSC)", "type": "date"},
        "RESP_DUE_DATE": {"label": "Response Due Date", "type": "date"},
    },
    "d_tblassociatedbond": {
        "DEC": {"label": "Bond Decision", "type": "lookup", "lookup": "bond_dec"},
        "INITIAL_BOND": {"label": "Initial Bond Amount", "type": "number"},
        "NEW_BOND": {"label": "New Bond Amount", "type": "number"},
        "BASE_CITY_CODE": {"label": "Court", "type": "lookup", "lookup": "base_city",
                           "lookup_table": "tbllookupbasecity", "code_col": "BASE_CITY_CODE", "desc_col": "BASE_CITY_NAME"},
        "HEARING_LOC_CODE": {"label": "Hearing Location", "type": "lookup", "lookup": "hearing_loc",
                             "lookup_table": "tbllookuphloc", "code_col": "HEARING_LOC_CODE", "desc_col": "HEARING_LOC_NAME"},
        ...
        "OSC_DATE": {"label": "Filing Date (OSC)", "type": "date"},
        "BOND_TYPE": {"label": "Bond Type", "type": "text"},
        "FILING_PARTY": {"label": "Filing Party", "type": "lookup", "lookup": "filed_by",
                         "lookup_table": "tbllookupfiledby", "code_col": "strCode", "desc_col": "strDescription"},
        "FILING_METHOD": {"label": "Filing Method", "type": "lookup", "lookup": "filing_method"},
        "BOND_HEARING_TELEPHONIC": {"label": "Telephonic Hearing", "type": "text"},
        "REL_CON": {"label": "Release Condition", "type": "text"},
    },
    "tbl_repsassigned": {
        ...
        "BASE_CITY_CODE": {"label": "Court", "type": "lookup", "lookup": "base_city",
                           "lookup_table": "tbllookupbasecity", "code_col": "BASE_CITY_CODE", "desc_col": "BASE_CITY_NAME"},
        "BLNPRIMEATTY": {"label": "Primary Attorney", "type": "text"},
        "PARENT_TABLE": {"label": "Parent Table", "type": "text"},
        "E_27_DATE": {"label": "E-27 Date", "type": "date"},
        "E_28_DATE": {"label": "E-28 Date", "type": "date"},
        "INS_TA_DATE_ASSIGNED": {"label": "Date Assigned", "type": "date"},
    },
    "tbl_custodyhistory": {
        "CUSTODY": {"label": "Custody Status", "type": "lookup", "lookup": "custody",
                    "lookup_table": "tbllookupcustodystatus", "code_col": "strCode", "desc_col": "strDescription"},
        "DATDETAINED": {"label": "Date Detained", "type": "date"},
        "DATRELEASED": {"label": "Date Released", "type": "date"},
    },
    "tblappeal": {
        "strAppealCategory": {"label": "Appeal Category", "type": "text"},
        "strAppealType": {"label": "Appeal Type", "type": "lookup", "lookup": "appeal_type",
                          "lookup_table": "tbllookupappealtype", "code_col": "strApplCode", "desc_col": "strApplDescription"},
        ...
        "datAttorneyE27": {"label": "Attorney E-27 Date", "type": "date"},
        "strFiledBy": {"label": "Filed By", "type": "lookup", "lookup": "filed_by",
                       "lookup_table": "tbllookupfiledby", "code_col": "strCode", "desc_col": "strDescription"},
        "strCaseType": {"label": "Case Type", "type": "lookup", "lookup": "case_type",
                        "lookup_table": "tbllookupcasetype", "code_col": "strCode", "desc_col": "strDescription"},
        "strNat": {"label": "Nationality", "type": "lookup", "lookup": "nationality",
                   "lookup_table": "tbllookupnationality", "code_col": "NAT_CODE", "desc_col": "NAT_NAME"},
        "strLang": {"label": "Language", "type": "lookup", "lookup": "language",
                    "lookup_table": "tbllanguage", "code_col": "strCode", "desc_col": "strDescription"},
        "strCustody": {"label": "Custody Status", "type": "lookup", "lookup": "custody",
                       "lookup_table": "tbllookupcustodystatus", "code_col": "strCode", "desc_col": "strDescription"},
        "strProbono": {"label": "Pro Bono", "type": "text"},
    },
}
